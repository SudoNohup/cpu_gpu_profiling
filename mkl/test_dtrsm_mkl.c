...
//  printf("%f\t", (1.0*m*n*k* 1e-6)/ fastest_time);
//  printf("%f\t", (1.0*m*n*k* 1e-6)/ slowest_time);
//  printf("%f\t", (1.0*m*n*k* 1e-6)/ average_time);
